<?php
  ...
  $skills = [
    'name' => ['Adobe Photoshop', 'Photography', 'Illustrator', 'Media'],
    'level' => [90, 85, 75, 75]
  ];

  $experience = [
    'title' => ['Front End Developer', 'Web Developer / something.com
    ', 'Graphic Designer / designsomething.com'],
    'date' => ['Jan 2015', 'Current', 'Mar 2012', 'Dec 2014', 'Jun 2010'],
  ...
  //разбиваем что бы получить отдельно день, месяц, год в массив
  $birthDate = explode("/", $birthDate);
  //в языке я так понял реализовано так что сначала идет месяц, поэтому [1] впереди
  //ну и от текущих даты и времени отнимаем дату рождения
  $days = floor((time() - mktime(0, 0, 0, $birthDate[1], $birthDate[0], $birthDate[2]))/(60*60*24));
  $age = floor($days/365);
  // echo "Days is: " . $days;
  // echo "Age is:" . $age;
?>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="https://sun9-43.userapi.com/impg/FfC3ppoes1tenIokjv-wkDE0OBhDiGXezu85ig/QQIoRkqZEJ8.jpg?size=320x213&quality=95&crop=99,0,1082,720&sign=6bf814394b2d33c2d1f759879b05b280&c_uniq_tag=DSiD05hCSpa5mIwXI7ohes0Dif2JVoP3u4Xrpbkkhlc&type=album" style="width:100%" alt="Avatar">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-calendar fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $age; ?> / </i><?php echo $days; ?></p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['title'][0]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['date'][0]; ?> - <span class="w3-tag w3-teal w3-round"><?php echo $experience['date'][1]; ?></span></h6>
          <p><?php echo $experience['description'][0]; ?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['title'][1]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['date'][2]; ?> - <?php echo $experience['date'][3]; ?></h6>
          <p><?php echo $experience['description'][1]; ?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['title'][2]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['date'][4]; ?> - <?php echo $experience['date'][2]; ?></h6>
